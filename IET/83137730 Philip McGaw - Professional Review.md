...
I have experience of working with test equipment such as Spectrum Analysers, Oscilloscopes, Electromagnetic Probes, GTEM Cells, and Digital Multi-meters to analyse and interpret the physical response of a circuit and evaluate against theoretical and simulated responses.

I am experienced at deriving theoretical circuit responses mentioned above from first principles and allying mathematical principals.

Some projects I have worked on required me to reverse engineer products without any design documentation to gain an insight into how the original designer came up with the solution and what modifications should be done to improve performance or reduce cost. 
...
Some of the requirements I was responsible for ensuring compliance with have safety impact, requiring the correct operation of the component over the vehicle’s entire life. One of the more problematic components I am working with is a ‘Hands-on Detection’ ECU for a steering wheel, where I am collaborating with the component owner. I provide technical electrical guidance while he is talking to the manufacturer, while I also liaise with the testing facilities reporting the EMC failures and advise on component re-design to resolve the failed tests.

I recently performed a research investigation into the applicability of GB 8702 and ICNIRP standards to JLR’s line of EVs (electric vehicles). The outcome of this investigation was a presentation to my colleges with recommendations on EMC emission limits that should be applied by JLR to comply with the legal requirements in all markets. To support this work, I investigated on my own initiative to perform back to back comparison of three different types of Electromagnetic probes and justified my recommendation at the type most appropriate for supporting JLR in testing going forward. While there has been no formal change of test procedures yet, there is an active discussion on what the best procedure is. I have been performing more investigation work to gain understanding about the issues around EMF and the implications regarding components within the vehicle. The longer-term output from this is to feed the understanding back into a revised version of the JLR component specification.

There is an on-going project to build new EMC testing facilities within JLR, I was responsible for producing the technical requirements document for the two new labs, Amplifier room, and the auxiliary equipment. This document was used by three prospective suppliers to come up with technical proposals and quotes, and then was used as the basis for judging the submissions against the requirements. The outcome of this was that one supplier was awarded the work as they managed to meet JLRs requirements and showed good value for money.

While at JLR I continued to learn new skills, taking advantage of the companies training scheme to acquire more JLR qualifications that are relevant for my role; I am also studying external courses on Coursera covering ADAS (Advanced driver-assistance systems), and other autonomous driving training, that are less focused on what I am currently doing in work, and more on where I have a general interest.
